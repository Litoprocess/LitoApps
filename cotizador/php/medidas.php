<?php
    ...
    $id_meterial=$_POST['id_meterial'];
   
    $sql="SELECT ID_MATERIAL, NOMBRE_MATERIAL, ANCHO1, ALTO1, ANCHO2, ALTO2, ANCHO3, ALTO3, ANCHO4, ALTO4, ANCHO5, ALTO5, TIPO, IMPORTE, MONEDA, PROVEEDOR, ACTIVO, TRASLUCIDO, CORTE FROM materiales_cotizador WHERE ID_MATERIAL=$id_meterial";
