<?php
    ...
    $insertar = "INSERT INTO botacora_complemento (FOLIO, TOTAL_ANCHO, TOTAL_ALTO, M_MEDIDA, M_ANCHO, M_ALTO, M_ENTRA, M_APROV, M_ORIENTA, RES_CANT, TIT_CANT_MAT, RES_PRECIO, RES_BLANCO, RES_ACAB1, RES_ACAB2, RES_ACAB3, RES_LAM, RES_ADIC1, RES_ADIC2, RES_ADIC3, RES_SUBTOTAL, RES_MARGEN, RES_COMISION, RES_PRECIO_UNITARIO, RES_LITO) VALUES ('$foliob','$TOTAL_ANCHO','$TOTAL_ALTO','$M_MEDIDA','$M_ANCHO','$M_ALTO','$M_ENTRA','$M_APROV','$M_ORIENTA','$RES_CANT','$TIT_CANT_MAT','$RES_PRECIO','$RES_BLANCO','$RES_ACAB1','$RES_ACAB2','$RES_ACAB3','$RES_LAM','$RES_ADIC1','$RES_ADIC2','$RES_ADIC3','$RES_SUBTOTAL','$RES_MARGEN','$RES_COMISION','$RES_PRECIO_UNITARIO','$RES_LITO')";
    //$insertar = "INSERT INTO botacora_complemento (FOLIO, TOTAL_ANCHO, TOTAL_ALTO, M_MEDIDA, M_ANCHO, M_ALTO, M_ENTRA, M_APROV, M_ORIENTA, RES_CANT, TIT_CANT_MAT, RES_PRECIO, RES_TINTA, RES_BARNIZ, RES_BLANCO, RES_ACAB1, RES_ACAB2, RES_ACAB3, RES_LAM, RES_ADIC1, RES_ADIC2, RES_ADIC3, RES_SUBTOTAL, RES_MARGEN, RES_COMISION, RES_PRECIO_UNITARIO, RES_IMPRIMART, RES_LITO) VALUES ('$foliob','$TOTAL_ANCHO','$TOTAL_ALTO','$M_MEDIDA','$M_ANCHO','$M_ALTO','$M_ENTRA','$M_APROV','$M_ORIENTA','$RES_CANT','$TIT_CANT_MAT','$RES_PRECIO','$RES_TINTA','$RES_BARNIZ','$RES_BLANCO','$RES_ACAB1','$RES_ACAB2','$RES_ACAB3','$RES_LAM','$RES_ADIC1','$RES_ADIC2','$RES_ADIC3','$RES_SUBTOTAL','$RES_MARGEN','$RES_COMISION','$RES_PRECIO_UNITARIO','$RES_IMPRIMART','$RES_LITO')";
