...
<head> 
  ...
  <link rel="stylesheet" href="css/responsive.jqueryui.min.css">  
    <link rel="stylesheet" href="../css/estilos.panel.css">
  ...
  <?php require 'layout/aside.php'; ?>
    ...
    <nav class="nav-extended indigo darken-3">
      <div class="nav-wrapper">
        <a id="titulo" style="margin-left: 50px; font-size:22px;" class="breadcrumb" href="#!">Propuestas a Clientes</a>
