...
$pdf->Cell(190,6,'REPORTE DE PROCESOS X OPERADOR',0,0,'C');
$pdf->Ln(15);
$pdf->SetFont('Arial','B',8);
//$pdf->Cell(20,4,'',1,0,'C');
$pdf->Cell(22,4,'ID OPERADOR: ',0,0,'L');
$pdf->Cell(10,4,$operador,0,0,'C');
$pdf->Cell(15,4,'NOMBRE: ',0,0,'L');

$sql1="execute dbo.ReporteOperador '$fechainicio','$fechafin','$operador'";
...
while($row1 = sqlsrv_fetch_array($stmt1,SQLSRV_FETCH_ASSOC))
{
   ...
   $pdf->Cell(40,4,$data1[0]['Empleado'],0,0,'C');
   $pdf->Cell(24,4,'',0,0,'C');
   ...
   $pdf->SetFont('Arial','B',8);
   $pdf->Cell(11,8,'# Orden',0,0,'C');
   $pdf->Cell(41,8,'Nombre Trabajo',0,0,'C');
   //$pdf->Cell(10,8,'ID.ACT',0,0,'C');
   $pdf->Cell(35,8,'Descripcion',0,0,'C');
   ...
   $pdf->Cell(21,8,'Fecha Turno',0,0,'C');
...
$pdf->SetFont('Arial','',6);
$pdf->Cell(11,8,$row['NumOrden'],0,0,'C');
$pdf->Cell(41,8,substr($row['NombreTrabajo'],0,30),0,0,'L');
//$pdf->Cell(10,8,$row['IdAct'],0,0,'C');
$pdf->Cell(35,8,substr($row['Descripcion'],0,25),0,0,'L');
$pdf->Cell(17,8,substr($row['Proceso'],0,16),0,0,'L');
...
$pdf->Cell(21,8,$row['Fechaproduccion']->format('d-m-Y'),0,0,'C');
//$pdf->Cell(20,6,$row['Operador'],0,0,'C');
$pdf->Ln(3);

}
$pdf->Ln(5);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(93,5,"SE HICIERON: ");
$pdf->Ln(6);
$pdf->SetFont('Arial','',6);
//$pdf->Cell(16,4,"SE HICIERON:",0,0,'L');
$pdf->Cell(15,4,number_format($data[0]['AjusteLito'],2),0,0,'R');
$pdf->Cell(25,4,"AJUSTES NORMALES",0,0,'L');
$pdf->Ln();
$pdf->Cell(15,4,number_format($data[0]['AjusteVWStd'],2),0,0,'R');
$pdf->Cell(30,4,"AJUSTES DE LITERATURA",0,0,'L');
$pdf->Ln();
$pdf->Cell(15,4,number_format($data[0]['Tiros']),0,0,'R');
$pdf->Cell(25,4,"TIROS",0,0,'L');
...
$pdf->SetFont('Arial','B',12);
$pdf->Cell(90,4,"EFICIENCIA: ",0,0,'R');
...
$pdf->Ln();
$pdf->Cell(32,4,'SE DEBIO HABER HECHO EN:',0,0,'C');
$pdf->Cell(10,4,number_format($data[0]['TiempoPrevisto'],2),0,0,'C');  
$pdf->Cell(7,4,'HRS.',0,0,'C'); 
...
$pdf->Cell(15,4,number_format($data[0]['AjusteVWStd']),0,0,'R');
$pdf->Ln();
