...
<head> 
  ...
  <link rel="stylesheet" href="../css/estilos.panel.css">
	<title>Reportes Produccion</title>
</head>
  ...
  <?php require 'layout/aside.php'; ?>
    ...
    <nav class="nav-extended indigo darken-3">
      <div class="nav-wrapper">
        <a style="margin-left: 50px; font-size:22px;" class="breadcrumb" href="#!">Reportes de Producción</a>
        ...
        <ul class="side-nav" id="mobile-demo">
          ...
          <?php switch( $_SESSION['Permisos']["UserReportesProduccion"] ) { 
          case 1: ?>
          <li id="sidereportes"><a href="reportes.php">Reportes</a></li>
