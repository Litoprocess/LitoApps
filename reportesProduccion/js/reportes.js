...
if(window.location.pathname == '/litoapps/reportesProduccion/reportes.php')
{
  ...
  Tiempo_M_SN_T, Cantidad_Produccion, Cantidad_Ajuste, TdA, VdT, TdAVW, Cantidad_AjusteVW, TiempoDeseado, TIempoAjusteTiro , eficiencia, porcentajeeficiencia;
  var d = new Date();
  ...
  {    
    ...
    if( $("select[id=tipoReporte]").val() === "operador"){  
    $.post('php/bitacora.php',{tipoReporte:tipoReporte, operador:operador, fechainicio:fechainicio, fechafin:fechafin},
      function(result){
      });      
   } 
   else if( $("select[id=tipoReporte]").val() === "maquina")
   {
    $.post('php/bitacora.php',{tipoReporte:tipoReporte, maquina:maquina, fechainicio:fechainicio, fechafin:fechafin},
      function(result){
      }); 
   }    
...
$.post('php/indicadores.php', {operador:operador,fechainicio:fechainicio,fechafin:fechafin},
  function(result)
  {
    ...
    {            
      ...
      $("#cantajusteliteratura").html(currency(result.data[0].AjusteVW,2));                                                      
