<?php
                ...
                {                      
                    ...
                    $consultaAcabado1=sqlsrv_query($conn,$acabado1);
                        ...
                        {   
                            ...
                            {
                                $nomAcabado1_1_1 = $row1["DESCRIPCION"];
                    ...
                    $consultaAcabado2=sqlsrv_query($conn,$acabado2);
                        ...
                        {   
                            ...
                            {
                                $nomAcabado2_1_1=$row2["DESCRIPCION"];
                    ...
                    $consultaAcabado3=sqlsrv_query($conn,$acabado3);
                        while ($row3 =sqlsrv_fetch_array($consultaAcabado3,SQLSRV_FETCH_ASSOC)) 
                        {   
                            ...
                            {
                                $nomAcabado3_1_1=$row3["DESCRIPCION"];
                    ...
                    $consultaAcabado4=sqlsrv_query($conn,$acabado4);
                        while ($row4 =sqlsrv_fetch_array($consultaAcabado4,SQLSRV_FETCH_ASSOC)) 
                        {   
                            ...
                            {
                                $nomAcabado4_1_1=$row4["DESCRIPCION"];
                    ...
                    $consultaAcabado5=sqlsrv_query($conn,$acabado5);
                        while ($row5 =sqlsrv_fetch_array($consultaAcabado5,SQLSRV_FETCH_ASSOC)) 
                        {   
                            ...
                            {
                                $nomAcabado5_1_1=$row5["DESCRIPCION"];
                    ...
                    $consultaAcabado6=sqlsrv_query($conn,$acabado6);
                        while ($row6 =sqlsrv_fetch_array($consultaAcabado6,SQLSRV_FETCH_ASSOC)) 
                        {   
                            ...
                            {
                                $nomAcabado6_1_1=$row6["DESCRIPCION"];
    ...
    //                }
                    ...
                    $this->Ln();
                    $this->Cell(100,5,"$a4_desc",1,0,'');
                    $this->Cell(30,5,"$$a4_precio",1,0,'');
                    $this->Cell(10,5,"",0,0,'');
                    $this->Cell(35,5,"",0,0); 

                    $this->Ln();
                    $this->Cell(100,5,"$a5_desc",1,0,'');
                    $this->Cell(30,5,"$$a5_precio",1,0,'');
                    $this->Cell(10,5,"",0,0,'');
                    $this->Cell(35,5,"",0,0); 

                    $this->Ln();
                    $this->Cell(100,5,"$a6_desc",1,0,'');
                    $this->Cell(30,5,"$$a6_precio",1,0,'');
                    $this->Cell(10,5,"",0,0,'');
                    $this->Cell(35,5,"",0,0);                                                                                                   
                    //fila 24
