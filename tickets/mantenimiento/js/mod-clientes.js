      ...
      function(form){ 
        ...
        if(form.validacion == "true"){
          ...
          Materialize.toast('Guardado', 1200,'blue darken-4',function(){
            ...
            $.post("correos/registroTicket.php", datosTicket + "&IdTicket=" + form.idAgregado + '&NombreUsuario=' + lsNombre + '&Departamento=' + lsDepartamento + '&CorreoUsuario=' + lsCorreo + '&CorreoCopia=' + $("#txt-correo2").val(), 'json');
