$(document).ready(function () {
  ...
  table = $('#all-tickets').DataTable( {
    ...
    {"defaultContent":"<a class='waves-effect waves-teal btn-flat btn-imp'><i class='material-icons'>print</i></a>"},
    {"data":"Correo"}
    ],
    "columnDefs": [
    {
...
datos_imp("#all-tickets tbody", table);
...
function datos_imp(tbody, table) {
 $(tbody).on("click", "a.btn-imp", function () {
