...
while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
    ...
    $_SESSION["UserMaquilas"] = $row['TipoUsuarioMaquilas'];
    $_SESSION["UserMuestras"] = $row['TipoUsuarioMuestras'];
    $_SESSION["UserRevBDD"] = $row['TipoUsuarioRevBDD'];         
    ...
    $_SESSION["MenuMaquilas"] = $row['EstatusMaquilas'];
    $_SESSION["MenuMuestras"] = $row['EstatusMuestras'];
    $_SESSION["MenuRevBDD"] = $row['EstatusRevBDD'];     
