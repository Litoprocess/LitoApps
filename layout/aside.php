<aside>
  <ul id="slide-out" class="side-nav fixed z-depth-2">
    ...
    <li class="bold">
      <a class="waves-effect" href="#" id="nav-app">
  ...
  <li class="bold" id="aside-capacitacion">
    <a class="waves-effect" href="capacitacion/index.php" id="nav-app12">
  ...
  <li class="bold" id="aside-inventario">
    <a class="waves-effect" href="inventarioSistemas/index.php" id="nav-app13">
      <i class="material-icons blue-text text-darken-4"><img src="icons/inventario_sistemas.png" alt="" width="25"></i>Inv.Sistemas
    </a>
  </li>
  <?php endif; ?>
