  ...
  <div class="row">   
    <div class="col s6">       
      <table id="dirGeneral" class="display row-border compact filtro" cellspacing="0" width="100%">
        <caption style="background: blue;"><b>Dirección General</b></caption>
        <thead>
          <tr class="lista">
            <th>Extensión</th>
            <th>Nombre</th>
      ...
      <table id="dirOpeyVen" class="hover row-border compact filtro" cellspacing="0" width="100%">
        <caption style="background: green;"><b>Dirección de Operaciones y Ventas</b></caption>
        <thead>
          <tr class="lista">
            <th>Extensión</th>
            <th>Nombre</th>
      ...
      <table id="gerSAM" class="hover row-border compact filtro" cellspacing="0" width="100%">
        ...
        <tbody class="nombres">
          <tr class="lista">
            <td><b>205</td>
            <td><b>Mario Escobedo</b></td>
            <td><b>Gerente SAM</b></td>
            <td><b>mescobedo@litoprocess.com</b></td>
          </tr>
          <tr class="lista">
            <td>219</td>
            <td>Jessica Martínez</td>
            <td>Operador SAM</td>
            <td>jmartinez@litoprocess.com</td>
          </tr>
          <tr class="lista">
            <td>222</td>
            <td>Samantha Mendez</td>
            <td>Operador SAM</td>
            <td>saam@litoprocess.com</td>
          </tr>          
          <tr class="lista">
            <td>202</td>
            <td>Miriam Navarrete</td>
            <td>Diseñador Senior</td>
            <td>mnavarrete@litoprocess.com</td>
          </tr>                                                                  
        </tbody>
      </table>
      <br>
      <table id="gerPlanta" class="hover row-border compact filtro" cellspacing="0" width="100%">
        ...
        <tbody class="nombres">
          ...
          <tr class="lista">
            <td>123</td>
            <td>Angélica Sánchez</td>
            <td>Cotizador</td>
            <td>asanchez@litoprocess.com</td>
          </tr> 
          <tr class="lista">
            <td>137</td>
            <td>Cinthia Jiménez</td>
            <td>Cotizador</td>
        ...
        <table id="sistemas" class="hover row-border compact filtro" cellspacing="0" width="100%">
          ...
          <tbody class="nombres">
            <tr class="lista">
              <td><b>214</b></td>
              <td><b>Alejandro Flores</b></td>
              <td><b>Gerente de Sistemas</b></td>
              <td><b>maflores@litoprocess.com</b></td>
            </tr>
            <tr class="lista">
              <td>206</td>
              <td>Jessica Montoya</td>
              <td>Soporte Intelisis</td>
              <td>jmontoya@litoprocess.com</td>
            </tr>
            <tr class="lista">
              <td>209</td>
              <td>Arturo Gómez</td>
              <td>Soporte Técnico</td>
              <td>soporte@litoprocess.com</td>
            </tr>
            <tr class="lista">
              <td>209</td>
              <td>Daniel Lozano</td>
              <td>Auxiliar de Soporte</td>
              <td>dlozano@litoprocess.com</td>
            </tr>           
            <tr class="lista">
              <td>220</td>
              <td>Cynthia Otero</td>
              <td>Administrador de Datos</td>
              <td>procesodatos@litoprocess.com</td>
            </tr>
            <tr class="lista">
              <td>223</td>
              <td>Geovanny Sánchez</td>
              <td>Desarrollo de Software</td>
              <td>desarrollo_software@litoprocess.com</td>
            </tr>
            <tr class="lista">
              <td>224</td>
              <td>Sergio García</td>
              <td>Desarrollo de Software</td>
              <td>sgarcia@litoprocess.com</td>
            </tr>
            <tr class="lista">
              <td>225</td>
              <td>Marco Estelles</td>
              <td>Desarrollo PHP</td>
              <td>mestelles@litoprocess.com</td>
            </tr>                                                                     
          </tbody>
        </table>  
        <br>
        <table id="gerCalidad" class="display row-border compact filtro" cellspacing="0" width="100%">
          ...
          <tbody class="nombres">
            <tr class="lista">
              <td><b>409</b></td>
              <td><b>Mario Legorreta</b></td>
              <td><b>Gerente de calidad</b></td>
              <td><b>mlegorreta@litoprocess.com</b></td>
            </tr>
            <tr class="lista">
              <td>807/510</td>
              <td>Auditoria de calidad</td>
              <td>Mesa de Control</td>
              <td>calidad@litoprocess.com</td>
            </tr>                                                        
          </tbody>
        </table>
        <br>
      ...
      <div class="col s6">
        <table id="capHumano" class="hover row-border compact filtro" cellspacing="0" width="100%">
          ...
          <tbody class="nombres">
            <tr class="lista">
              <td><b>406</b></td>
              <td><b>Enrique Hernández</b></td>
              <td><b>Gerente de Capital Humano</b></td>
              <td><b>enhernandez@litoprocess.com</b></td>
            </tr>
            <tr class="lista">
              <td>410</td>
              <td>Diana Martínez</td>
              <td>Integración y desarrollo</td>
              <td>integracion@litoprocess.com</td>
            </tr>
            <tr class="lista">
              <td>411</td>
              <td>Viviana García</td>
              <td>Obligaciones obrero-patronales</td>
              <td>capitalhumano@litoprocess.com</td>
            </tr>
            <tr class="lista">
              <td>412</td>
              <td>Fernanda Caballero</td>
              <td>Auxiliar de Nominas</td>
              <td>nominas@litoprocess.com</td>
            </tr>            
            <tr class="lista">
              <td>101</td>
              <td>Eva Márquez</td>
              <td>Recepcionista</td>
              <td>recepcion@litoprocess.com</td>
            </tr>
            <tr class="lista">
              <td>811</td>
              <td>Karen Sandoval</td>
              <td>Seg. Hig. y Medio Ambiente</td>
              <td>seguridadehigiene@litoprocess.com</td>
            </tr>                                                                                     
          </tbody>
        </table>
        <br>
        ...
        <table id="gerVentas" class="hover row-border compact filtro" cellspacing="0" width="100%">
          ...
          <tbody class="nombres">
            ...
            <tr class="lista">
              <td>516</td>
              <td>Ma. de los Ángeles Gallegos</td>
              <td>Supervisor</td>
      ...
      <div class="offset-s4 col s4 offset-s4">
        ...
        <table id="emergencias" class="hover row-border compact filtro" cellspacing="0" width="100%">
          <caption style="background:  grey;"><b>Teléfonos de Emergencias en Naucalpan</b></caption>
          <thead>
            <tr class="lista">
              <th>Dependencia</th>
              <th>Número</th>                                                  
