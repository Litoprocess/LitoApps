...
<head> 
  ...
  <link rel="stylesheet" href="css/estilos.manttoprev.css">
  ...
  <?php require 'layout/aside.php'; ?>
    ...
    <nav class="nav-extended indigo darken-3">
      <div class="nav-wrapper">
        <a style="margin-left: 50px; font-size:22px;" class="breadcrumb" href="#!">Mantenimiento Preventivo</a>
        <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
        <ul id="nav-mobile" class="right hide-on-med-and-down">

          <?php switch( $_SESSION['Permisos']["UserMaquilas"] ) { 
          case 1: ?>
          <li><a href="programa.php">Calendario</a></li>
          <li id="mantenimientos"><a href="mantenimientos.php">Listado</a></li>  
          <li id="mantenimientosDepto"><a href="mantenimientosDepto.php">Departamento</a></li>               
          <?php
          break;
        ...
        <ul class="side-nav" id="mobile-demo">
          ...
          <?php switch( $_SESSION['Permisos']["UserMaquilas"] ) { 
          case 1: ?>
          <li id="siderprograma"><a href="programa.php">Calendario</a></li>
          <li id="sidemantenimientos"><a href="mantenimientos.php">Listado</a></li>  
           <li id="mantenimientosDepto"><a href="mantenimientosDepto.php">Departamento</a></li>           
          <?php
          break;
